...
func TestParseFile(t *testing.T) {
	// TODO: Parser expects specific header text but test fixture only has "header" placeholders
	// Need to update fixture with actual ISX header row format (Arabic + English column names)
	t.Skip("Parser header detection needs actual ISX header format, not placeholder 'header' text")
