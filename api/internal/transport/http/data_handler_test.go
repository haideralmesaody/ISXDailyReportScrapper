...
func (m *MockDataService) GetIndicesHistory(ctx context.Context, startDate, endDate string) (map[string]interface{}, error) {
...
func (m *MockDataService) GetTradingDates(ctx context.Context) ([]string, error) {
	args := m.Called()
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockDataService) GetDailyMarketData(ctx context.Context, date string) ([]map[string]interface{}, error) {
	args := m.Called(date)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockDataService) GetDailyMarketDataWithHistory(ctx context.Context, date string, historyDays int) ([]map[string]interface{}, error) {
	args := m.Called(date, historyDays)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).([]map[string]interface{}), args.Error(1)
...
func (m *MockDataService) CreateTradeSchedule(ctx context.Context, ticker string, totalTradeValue float64) (interface{}, error) {
	args := m.Called(ticker, totalTradeValue)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0), args.Error(1)
...
func (m *MockDataService) EstimateTradeImpact(ctx context.Context, ticker string, tradeValue float64) (float64, error) {
	args := m.Called(ticker, tradeValue)
	return args.Get(0).(float64), args.Error(1)
}

func (m *MockDataService) GetSafeTradingLimits(ctx context.Context, ticker string) (interface{}, error) {
	args := m.Called(ticker)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
